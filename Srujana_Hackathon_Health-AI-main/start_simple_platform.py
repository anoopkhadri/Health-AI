#!/usr/bin/env python3
"""
Simple Health AI Platform Startup Script
"""
import os
import sys
import subprocess
...
def check_mysql():
    ...
    print("   Port: 3306")
    print("   User: root")
    print("   Password: password (change in app.py)")
    print("   Database: health_ai_db (will be created automatically)")
    return True

def start_backend():
    """Start the Flask backend"""
    print("\n🚀 Starting Simple Health AI Platform...")
...
def main():
    ...
    print("🏥 Simple Health AI Platform Startup")
    print("=" * 50)
